...
_commonutils2.default.render(indextpl);
...
var commonutil = {
	render: function render(str) {
		var container = document.getElementById("football-container");
...
module.exports = "<div>fdsffs</div><div  id=\"box\">	<input type=\"text\" name=\"\" id=\"\" value=\"\" v-model=\"message\" />	{{message}}</div>"
